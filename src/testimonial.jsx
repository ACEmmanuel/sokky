    ...
    <div style={{backgroundImage :" url('./bottombg.png')"}} className='font-DM pt-4'>
        <div className="container mx-auto text-white/90 mt-20">
            <div className='text-center mx-auto px-4 max-w-4xl '>
                ...
                <h1 className='text-3xl sm:text-4xl mt-2 font-rale font-[600]'>What people say</h1>
                <p className='mt-6 text-[16px] md:text-[18px] font-medium text-balance text-[#B3B4B7]'>You can buy and sell 150+ cryptocurrencies with 20+ fiat
                <br /> currencies using bank transfer on your credit or debit card</p>
            </div>
            

            <div className='mx-auto flex flex-wrap items-center md:w-[100%] px-3 gap-x-5 lg:gap-x-0'>
                            ...
                            
                {
                    data.map((e) => {
                        ...
                        return (
                           <div className='flex flex-col gap-2 rounded-xl mt-10 w-[35rem] p-12 mx-auto bg-gradient-to-b from-[#282930] text-[1rem] font-medium' key={id}>
                                <div className='font-bold text-3xl'>*****</div>
                                <div className='w-[90%]'>{review}</div>
